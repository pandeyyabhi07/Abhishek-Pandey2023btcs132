    ...
    <footer className="bg-gray-100 border-t border-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><a href="#" className="hover:text-purple-600 transition-colors">AI Integration</a></li>
                <li><a href="#" className="hover:text-purple-600 transition-colors">Cloud Solutions</a></li>
              </ul>
            </div>
            ...
            {/* Contact */}
            <div>
              <h3 className="font-bold mb-4 text-gray-900">Let’s Connect</h3>
              <div className="space-y-2 text-gray-600">
                <p><span className="font-semibold">Email:</span> kumar.234ankit@gmail.com</p>
                <p><span className="font-semibold">Phone:</span> +91 9654567890</p>
                <p>
          ...
          {/* Bottom */}
          <div className="border-t border-gray-300 mt-8 pt-8 text-center text-gray-600 text-sm sm:text-base">
            <p>
